...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    """
    statement = power_pellet_active and touching_ghost
...
def score(touching_power_pellet, touching_dot):
    ...
    """
    statement = touching_power_pellet or touching_dot
    return statement
...
def lose(power_pellet_active, touching_ghost):
    ...
    """
    statement = touching_ghost and not power_pellet_active
    return statement
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    statement = has_eaten_all_dots and not lose(power_pellet_active, touching_ghost)
    return statement
