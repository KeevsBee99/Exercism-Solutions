...
def exchange_money(budget, exchange_rate):
    ...
    """
    final_value = budget / exchange_rate
    return final_value
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    """
    num_bills = denomination * number_of_bills
    return num_bills
...
def get_leftover_of_bills(amount, denomination):
    ...
    new_bill = float(num_bills * denomination) 
    left_over = amount - new_bill
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    spr_fee = (spread/100)*exchange_rate
    final_exchange_rate = exchange_rate + spr_fee
    
    exchange_money_calc = budget/final_exchange_rate
    exchange_money_into_bills = exchange_money_calc//denomination
    final_value = exchange_money_into_bills * denomination
    return final_value
